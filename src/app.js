class MonotoneShape extends HTMLElement {
  ...
  getSVGByShapeId(shapeId) {
    ...
    const svgs = {
      1: `<svg  width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      2: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      3: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      4: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="6" height="16" rx="1" transform="matrix(-0.573576 -0.819152 -0.819152 0.573576 18.2743 9.86893)" fill="#292929" fill-opacity="0.52"/>
      ...
      5: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      6: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      7: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      8: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      9: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      10: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M21 6H2V15L21 6Z" fill="#292929" fill-opacity="0.52"/>
<path d="M21 19H2V10L21 19Z" fill="#2C2C2D" fill-opacity="0.82"/>
</svg>
`,
      11: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      12: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      13: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      14: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      15: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      16: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      17: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      18: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      19: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      20: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      21: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      22: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      23: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
      24: `<svg width="${width?width:24}" height="${height?height:24}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
